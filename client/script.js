...
function drawNewCard(id, text, x, y, rot, colour, sticker, animationspeed) {
    ...
    var startPosition = $("#create-white-card").position();
    ...
    $("#create-blue-card")
        .click(function() {
            ...
            createCard(
                'card' + uniqueID,
                '',
                40, $('div.board-outline').height()+50, // hack - not a great way to get the new card coordinates, but most consistant ATM
                rotation,
                'blue');
        });
        ...
        .click(function() {
            ...
            console.log('Clicked yellow card');
            var rotation = Math.random() * 10 - 5; //add a bit of random rotation (+/- 10deg)
            uniqueID = Math.round(Math.random() * 99999999); //is this big enough to assure uniqueness?
            //alert(uniqueID);
            createCard(
                'card' + uniqueID,
                '',
                240, $('div.board-outline').height()+50, // hack - not a great way to get the new card coordinates, but most consistant ATM
                rotation,
                'yellow');
        });
        ...
        .click(function() {
            ...
            console.log('Clicked white card');
            var rotation = Math.random() * 10 - 5; //add a bit of random rotation (+/- 10deg)
            uniqueID = Math.round(Math.random() * 99999999); //is this big enough to assure uniqueness?
            //alert(uniqueID);
            createCard(
                'card' + uniqueID,
                '',
                440, $('div.board-outline').height()+50, // hack - not a great way to get the new card coordinates, but most consistant ATM
                rotation,
                'white');
        });
        ...
        $("#create-green-card")
        .click(function() {
            console.log('Clicked green card');
            var rotation = Math.random() * 10 - 5; //add a bit of random rotation (+/- 10deg)
            uniqueID = Math.round(Math.random() * 99999999); //is this big enough to assure uniqueness?
            //alert(uniqueID);
            createCard(
                'card' + uniqueID,
                '',
                640, $('div.board-outline').height()+50, // hack - not a great way to get the new card coordinates, but most consistant ATM
                rotation,
                'green');
        });
